...
public class AnswerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<String> seriesArrayList;
    ...
    public List<String> getSeriesArrayList() {
        return seriesArrayList;
    }

    public void setSeriesArrayList(List<String> seriesArrayList) {
...
//        }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder mholder, int position) {
        ...
        String adSubCategory=seriesArrayList.get(position);
...
//        ServiceCategory avaialbleCityPojo=seriesArrayList.get(position);
       // holder.categoryText.setText(adSubCategory.getLine());
        holder.resultEdit.setText(adSubCategory, TextView.BufferType.SPANNABLE);
        if(position%2==0){

...
public class StoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public StoryAdapter(Activity activity, List<StoryPojo> subCategoryList) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder mholder, int position) {
        ...
        StoryPojo adSubCategory=seriesArrayList.get(position);
        //holder.categoryImage.setTe(adSubCategory.getCategory_name());
//        ServiceCategory avaialbleCityPojo=seriesArrayList.get(position);
        holder.categoryText.setText(adSubCategory.getName());
        holder.priceText.setText(adSubCategory.getShort_desc());
        ...
        holder.parent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //List<StoryItemPojo> storyItemPojoList=storyPojo.getStoryItemPojoList();
               // ((HomeActivity)activity).setItemAdapter(storyItemPojoList);
            }
        });
//
